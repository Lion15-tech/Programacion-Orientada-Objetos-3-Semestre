'''
Este código te permite ver todas las fuentes que tengas instaladas en tu computadora
'''
...
def actualizar_vista_previa(event):
    ...
    if seleccion:
        ...
        lbl_nombre_fuente.config(text=f"Fuente actual: {fuente_seleccionada}")
...
# 6. Eventos: Ejecutar la función cuando cambie la selección (clic o teclado)
